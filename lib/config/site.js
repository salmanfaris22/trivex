...
keywords: [
  ...
  "best app developers in Calicut",
  "software company near me Kerala",
  "startup tech support Kerala",
  "digital agency near me",
  "Kerala startup development company",
  "software company near Calicut University",
  "tech partner for startups Kerala",
  "business automation services Kerala"
],

	authors: [
		{
			name: 'salmanfaris.dev',
			url: 'https://instagram.com/salmanfaris.dev',
		},
	],
	icons: {
		icon: '/logo.png',
