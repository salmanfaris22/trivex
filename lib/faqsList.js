export const FAQList = {
 FAQ_EN: [
  {
    question: "What does Traivex do?",
    answer:
      "Traivex provides complete digital solutions including custom software development, business systems, web and app design, media production, and technical project execution.",
  },
  {
    question: "Who can work with Traivex?",
    answer:
      "Startups, small businesses, agencies, and entrepreneurs looking for reliable digital systems and technical execution can work with us.",
  },
  {
    question: "Do you handle projects from start to finish?",
    answer:
      "Yes. We manage everything from planning and design to development, deployment, and support.",
  },
  {
    question: "Can Traivex build custom business software?",
    answer:
      "Absolutely. We create tailored platforms, internal tools, and systems based on your business requirements.",
  },
  {
    question: "Do you provide website and app design?",
    answer:
      "Yes, we design modern, responsive, and user-focused digital experiences for brands and businesses.",
  },
  {
    question: "Do you offer media and video editing services?",
    answer:
      "Yes. We create professional promotional, branding, and business video content.",
  },
  {
    question: "How do we start a project with Traivex?",
    answer:
      "You can contact us with your project details. After discussion and planning, we provide a structured proposal and timeline.",
  },
  {
    question: "Do you provide support after project delivery?",
    answer:
      "Yes. We offer post-launch support and maintenance based on project agreements.",
  },
  {
    question: "How long does a project take?",
    answer:
      "Timelines depend on project scope and complexity. We provide a clear schedule before starting.",
  },
  {
    question: "Do you work with international clients?",
    answer:
      "Yes, Traivex collaborates with clients across different regions through remote project management.",
  },
  {
    question: "Is pricing fixed or flexible?",
    answer:
      "Pricing depends on project requirements, features, and timelines. We provide transparent cost breakdowns.",
  },
  {
    question: "How can I contact Traivex?",
    answer:
      "You can reach us through our website contact form or official communication channels.",
  },
],
